...
namespace CamServerOne
{
	public class HttpProcessor
	{
		...
		public Dictionary<string,string> httpResponseHeaders = new Dictionary<string,string>();
		...
		public void writeSuccess(string content_type="text/html")
		{
			...
			foreach(var kvp in httpResponseHeaders) {
				outputStream.WriteLine(kvp.Key+": "+kvp.Value);
			}
		...
		{
			if (error != null) {
				outputStream.WriteLine("HTTP/1.0 500 Server Error");
				outputStream.WriteLine("Content-Type: text/plain");
				outputStream.WriteLine("Connection: close");
				outputStream.WriteLine("");
				outputStream.WriteLine(error.ToString());
			} else {
